...
def strip_tone(reading: str) -> str:
    ...
    # "lü" arrives as "lu" after NFD, which would collide with 路(lù); pinyin-data writes ü as
    # "ü", and the input-method convention is "v", so both spellings map to v here.
