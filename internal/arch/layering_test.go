...
var allowed = map[string][]string{
	...
	"internal/orgtree":  {"internal/domain"},
	"internal/registry": {"internal/domain", "internal/orgtree"},
	...
	"internal/store":       {"internal/config", "internal/domain", "internal/orgtree", "internal/secret"},
