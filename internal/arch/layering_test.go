...
var allowed = map[string][]string{
	...
	"internal/httpapi": {
		...
		"internal/modelmap", "internal/pricing", "internal/providers", "internal/quota",
		"internal/registry", "internal/responses", "internal/routing", "internal/runtime",
		"internal/secret", "internal/store", "internal/usage", "pkg/pluginapi",
	},
}
