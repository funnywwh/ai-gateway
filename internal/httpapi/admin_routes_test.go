...
var expectedAdminPatterns = []string{
	...
	"DELETE /admin/api/v1/accounts/{id}/feishu",
	...
	"DELETE /admin/api/v1/dshgw/nodes/{name}",
	...
	"GET /admin/api/v1/dshgw/nodes",
	"GET /admin/api/v1/dshgw/nodes/{name}/audit",
	"GET /admin/api/v1/dshgw/nodes/{name}/deploy",
	...
	"PATCH /admin/api/v1/dshgw/nodes/{name}",
	...
	"POST /admin/api/v1/dshgw/nodes",
	"POST /admin/api/v1/dshgw/nodes/{name}/deploy",
	"POST /admin/api/v1/dshgw/nodes/{name}/reconcile",
	"POST /admin/api/v1/dshgw/nodes/{name}/rotate-token",
	"POST /admin/api/v1/dshgw/tenants/{name}/restart",
	"POST /admin/api/v1/dshgw/tenants/{name}/node",
	"POST /admin/api/v1/hooks",
	"POST /admin/api/v1/invoices/{id}/{action}",
	"POST /admin/api/v1/keys",
	"POST /admin/api/v1/keys/import",
	"POST /admin/api/v1/keys/import-batch",
	"POST /admin/api/v1/keys/lookup",
	...
	"PUT /admin/api/v1/accounts/{id}/feishu",
